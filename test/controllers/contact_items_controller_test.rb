...
class ContactItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contact_item" do
    assert_difference('ContactItem.count') do
      post contact_items_url, params: { contact_item: { email: @contact_item.email, first_name: @contact_item.first_name, last_name: @contact_item.last_name, phone_number: @contact_item.phone_number, website: @contact_item.website } }
    end
  ...
  test "should update contact_item" do
    patch contact_item_url(@contact_item), params: { contact_item: { email: @contact_item.email, first_name: @contact_item.first_name, last_name: @contact_item.last_name, phone_number: @contact_item.phone_number, website: @contact_item.website } }
